...
test-sitl:
	MP_SITL_UDP_BIND="$(MP_SITL_UDP_BIND)" cargo test -p mp-telemetry-core sitl_roundtrip -- --ignored --nocapture --test-threads=1

test-sitl-strict:
	MP_SITL_UDP_BIND="$(MP_SITL_UDP_BIND)" MP_SITL_STRICT=1 cargo test -p mp-telemetry-core sitl_roundtrip -- --ignored --nocapture --test-threads=1
